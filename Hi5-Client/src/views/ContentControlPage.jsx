            ...
            <div className="flex justify-center mx-auto pt-[70px] md:pt-0 md:pl-[70px] lg:pl-[260px] w-full h-full">
                <div className="flex justify-center w-full max-w-3xl">
                    <div className="flex flex-col justify-center bg-white dark:bg-black shadow-lg my-0 md:my-4 px-4 rounded-lg w-full">
                        <div className="top-0 sticky p-2 md:p-2 w-full">
                        ...
                        <div className="bg-slate-200 dark:bg-slate-800 rounded-lg h-1"></div>

                        <div className="flex flex-col flex-1 items-center space-y-1 mb-2 rounded-b-lg overflow-y-auto hide-scrollbar">
                            {feedType === "POST" && (
                                <PostModeration />
                            )}
                            {feedType === "REEL" && (
