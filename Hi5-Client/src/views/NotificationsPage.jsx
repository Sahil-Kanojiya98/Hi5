...
// import { FaHeart, FaCommentDots, FaUserPlus, FaEnvelope } from "react-icons/fa";
...
//           <div className="top-0 z-10 sticky p-4">
//             <p className="font-semibold text-2xl text-gray-800 dark:text-gray-100">
//               Notifications
//             </p>
//           </div>
...
//               <div
//                 key={notification.id}
//                 className="flex sm:flex-row flex-col justify-between items-start sm:gap-4 bg-white hover:bg-gray-200 dark:hover:bg-gray-800 dark:bg-black p-4 rounded-lg transition-colors"
//               >
...
//                   </div>
//                   <div>
//                     <p className="flex sm:flex-row flex-col gap-2 font-semibold text-gray-900 text-sm sm:text-base dark:text-gray-100">
...
//                     <button className="bg-green-500 hover:bg-green-600 px-4 py-2 rounded-md text-sm text-white sm:text-base">
//                       Allow
//                     </button>
//                     <button className="bg-red-500 hover:bg-red-600 px-4 py-2 rounded-md text-sm text-white sm:text-base">
//                       Deny
//                     </button>
//                   </div>
//                 ) : (
//                   <Link
//                     to="#"
//                     className="ml-auto text-gray-600 text-xs sm:text-sm hover:text-gray-900 dark:hover:text-gray-100 dark:text-gray-500"
//                   >
//                     View
//                   </Link>
//                 )}
