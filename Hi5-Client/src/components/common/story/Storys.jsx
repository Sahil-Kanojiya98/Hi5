...
// const Stories = () => {
//   const [userStorys, setUserStorys] = useState([]);
...
//       const response = await getFollowingUsersStorys();
//       setUserStorys(response.data);
//     } catch (error) {
...
//         )}
//         {!isUsersStorysLoading &&
//           userStorys.map((user) => <Story key={user.id} user={user} />)}
//       </div>
