      ...
      >
        ...
        >
          <div className="flex justify-between items-center mb-4 text-xl">
            <h3 className="font-semibold">Liked Users</h3>
            <button
              onClick={closeModal}
...
export default ViewLikedUsersModel;
